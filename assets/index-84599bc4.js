 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(j,N){var D=j.length;j.push(N);e:for(;0<D;){var X=D-1>>>1,V=j[X];if(0<i(V,N))j[X]=N,j[D]=V,D=X;else break e}}function n(j){return j.length===0?null:j[0]}function r(j){if(j.length===0)return null;var N=j[0],D=j.pop();if(D!==N){j[0]=D;e:for(var X=0,V=j.length,bt=V>>>1;X<bt;){var Ce=2*(X+1)-1,Wt=j[Ce],Qe=Ce+1,Pt=j[Qe];if(0>i(Wt,D))Qe<V&&0>i(Pt,Wt)?(j[X]=Pt,j[Qe]=D,X=Qe):(j[X]=Wt,j[Ce]=D,X=Ce);else if(Qe<V&&0>i(Pt,D))j[X]=Pt,j[Qe]=D,X=Qe;else break e}}return N}function i(j,N){var D=j.sortIndex-N.sortIndex;return D!==0?D:j.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],h=1,f=null,m=3,S=!1,x=!1,w=!1,b=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(j){for(var N=n(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=j)r(u),N.sortIndex=N.expirationTime,t(s,N);else break;N=n(u)}}function g(j){if(w=!1,v(j),!x)if(n(s)!==null)x=!0,$e(_);else{var N=n(u);N!==null&&et(g,N.startTime-j)}}function _(j,N){x=!1,w&&(w=!1,p(C),C=-1),S=!0;var D=m;try{for(v(N),f=n(s);f!==null&&(!(f.expirationTime>N)||j&&!R());){var X=f.callback;if(typeof X=="function"){f.callback=null,m=f.priorityLevel;var V=X(f.expirationTime<=N);N=e.unstable_now(),typeof V=="function"?f.callback=V:f===n(s)&&r(s),v(N)}else r(s);f=n(s)}if(f!==null)var bt=!0;else{var Ce=n(u);Ce!==null&&et(g,Ce.startTime-N),bt=!1}return bt}finally{f=null,m=D,S=!1}}var k=!1,$=null,C=-1,P=5,E=-1;function R(){return!(e.unstable_now()-E<P)}function L(){if($!==null){var j=e.unstable_now();E=j;var N=!0;try{N=$(!0,j)}finally{N?z():(k=!1,$=null)}}else k=!1}var z;if(typeof c=="function")z=function(){c(L)};else if(typeof MessageChannel<"u"){var J=new MessageChannel,q=J.port2;J.port1.onmessage=L,z=function(){q.postMessage(null)}}else z=function(){b(L,0)};function $e(j){$=j,k||(k=!0,z())}function et(j,N){C=b(function(){j(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_continueExecution=function(){x||S||(x=!0,$e(_))},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(j){switch(m){case 1:case 2:case 3:var N=3;break;default:N=m}var D=m;m=N;try{return j()}finally{m=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(j,N){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var D=m;m=j;try{return N()}finally{m=D}},e.unstable_scheduleCallback=function(j,N,D){var X=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?X+D:X):D=X,j){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=D+V,j={id:h++,callback:N,priorityLevel:j,startTime:D,expirationTime:V,sortIndex:-1},D>X?(j.sortIndex=D,t(u,j),n(s)===null&&j===n(u)&&(w?(p(C),C=-1):w=!0,et(g,D-X))):(j.sortIndex=V,t(s,j),x||S||(x=!0,$e(_))),j},e.unstable_shouldYield=R,e.unstable_wrapCallback=function(j){var N=m;return function(){var D=m;m=N;try{return j.apply(this,arguments)}finally{m=D}}}})(Dp);Np.exports=Dp;var Wg=Np.exports;/**
 * @license React
...
`,Mx=y.div`
  ...
  justify-content: space-between;
  align-items: center;
`,Rx=({sections:e})=>{const t=Bt(),n=d.jsx(Nf,{children:d.jsx(Px,{children:If.signUp})}),r=d.jsx(Nf,{children:d.jsx(Tx,{children:If.signIn})});return t===null?null:d.jsxs(Cx,{children:[d.jsx(zx,{color:"transparent"}),t&&d.jsx(bx,{type:"button",children:d.jsx(d.Fragment,{}),onClick:Xw}),!t&&d.jsxs(d.Fragment,{children:[d.jsx(fm,{type:"light"}),d.jsx("nav",{children:d.jsx(Ex,{children:e.map(i=>d.jsx(Ox,{children:d.jsx(Mm,{to:i.id,spy:!0,smooth:!0,duration:500,children:i.title})},i.id))})}),d.jsxs(Mx,{children:[d.jsx(Lx,{type:"button",children:n,onClick:Kw}),d.jsx(jx,{type:"button",children:r,onClick:Zw})]})]})]})},{lightGrayColor:Rm}=pe,Ix=y.div`
  position: relative;
  z-index: 1;
  max-width: 19.16vw;
  display: flex;
...
`,Ot=({children:e,...t})=>d.jsx(Yx,{...t,children:e}),qx=y.p`
  ${Q};
  text-align: center;
...
`,mk=d.jsxs(pk,{children:[d.jsx(vk,{}),d.jsx(hk,{children:uu.button})]}),gk=()=>d.jsx(uk,{children:d.jsxs(ck,{children:[d.jsx(Ot,{color:Im,children:uu.title}),d.jsx(dk,{children:uu.text}),d.jsx(fk,{type:"button",children:mk,onClick:Jw})]})}),{whiteColor:Nm,darkGrayColor:yk}=pe,Ba={title:"Avaible Currencies",text:"A vast range of major coins, stablecoins and liquid tokens is available.",imagesContext:[{text:"Coins",image:"images/products-and-service/lineOne.svg"},{text:"Stablekoins",image:"images/products-and-service/lineTwo.svg"},{text:"Tokens",image:"images/products-and-service/lineThree.svg"}]},wk=y.section`
  ${Tr};
...
`,Ck=()=>{const e=Bt();return d.jsxs(wk,{children:[d.jsx(Ot,{color:Nm,children:Ba.title}),d.jsx(_k,{children:Ba.text}),d.jsx(Sk,{children:Ba.imagesContext.map((t,n)=>d.jsxs(H.Fragment,{children:[d.jsx(xk,{children:d.jsx($k,{children:t.text})}),d.jsx(kk,{children:e?d.jsx(Hf,{src:"images/products-and-service/line-S.svg",alt:t.text}):d.jsx(Hf,{src:t.image,alt:t.text})})]},n))})]})},{whiteColor:Ek}=pe,Ok=y.h4`
  ${Q};
  text-align: center;
...
`,bk=({children:e,...t})=>d.jsx(Ok,{...t,children:e}),{greenColor:Pk}=pe,Tk=y.div`
  width: 82.25vw;
...
`,H_=y.div`
  ...
  position: absolute;
  width: 10px;
`,F_=({children:e,...t})=>{const n=H.useRef(null),r=H.useRef(null),i=H.useRef(null),o=H.useRef(null),[l,a]=H.useState(20),[s,u]=H.useState(null),[h,f]=H.useState(0),[m,S]=H.useState(!1),[x,w]=H.useState(!1);function b(E,R){if(E){const{clientHeight:L,scrollHeight:z}=E;a(Math.max(L/z*R,20))}}const p=H.useCallback(E=>{if(E.preventDefault(),!m&&n.current&&i.current){const{scrollTop:R,scrollHeight:L}=n.current,{clientHeight:z}=r.current??{};let J=+R/+L*(z??0);J=Math.min(J,(z??0)-l);const q=i.current;q.style.top=`${J}px`}},[m,l]);H.useEffect(()=>{const E=n.current;if(E)return E.addEventListener("wheel",p,{passive:!1}),()=>{E.removeEventListener("wheel",p)}},[p]);const c=H.useCallback(E=>{E.preventDefault(),E.stopPropagation();const{clientY:R}=E,{clientHeight:L}=r.current,{current:z}=n;if(z){E.persist();const J=-(l/2),q=(R-E.currentTarget.offsetTop+J)/L,$e=Math.floor(q*z.scrollHeight);z.scrollTo({top:$e,behavior:"smooth"})}},[l]),v=H.useCallback(()=>{if(!m){if(!n.current||!r.current||!i.current)return;const{scrollTop:E,scrollHeight:R}=n.current,{clientHeight:L}=r.current;let z=+E/+R*L;z=Math.min(z,L-l);const J=i.current;J.style.top=`${z}px`}},[m,l]),g=H.useCallback(E=>{E.stopPropagation(),u(E.touches[0].clientY),n.current&&f(n.current.scrollTop),w(!0),S(!0)},[]),_=H.useCallback(E=>{E.preventDefault(),E.stopPropagation(),x&&(w(!1),S(!1))},[x]),k=H.useCallback(E=>{if(x){E.preventDefault(),E.stopPropagation();const{current:R}=n,{scrollHeight:L,offsetHeight:z}=R,J=(E.touches[0].clientY-s)*(L/z),q=Math.min(h+J,L-z);requestAnimationFrame(()=>{R.scrollTop=q})}},[x,s,h]),$=H.useCallback(E=>{if(x){E.preventDefault(),E.stopPropagation();const{current:R}=n,{scrollHeight:L,offsetHeight:z}=R,J=(E.clientY-s)*(L/z),q=Math.min(h+J,L-z);requestAnimationFrame(()=>{R.scrollTop=q})}},[x,s,h]),C=H.useCallback(E=>{E.preventDefault(),E.stopPropagation(),u(E.clientY),n.current&&f(n.current.scrollTop),w(!0),S(!0)},[]),P=H.useCallback(E=>{E.preventDefault(),E.stopPropagation(),x&&(w(!1),S(!1))},[x]);return H.useEffect(()=>{if(n.current&&r.current){const E=n.current,{clientHeight:R}=r.current;return o.current=new ResizeObserver(()=>{b(E,R)}),o.current.observe(E),E.addEventListener("scroll",v),()=>{var L;(L=o.current)==null||L.unobserve(E),E.removeEventListener("scroll",v)}}},[]),H.useEffect(()=>(document.addEventListener("touchmove",k,{passive:!1}),document.addEventListener("touchend",_,{passive:!1}),()=>{document.removeEventListener("touchmove",k),document.removeEventListener("touchend",_)}),[k,_]),H.useEffect(()=>(document.addEventListener("mousemove",$),document.addEventListener("mouseup",P),document.addEventListener("mouseleave",P),()=>{document.removeEventListener("mousemove",$),document.removeEventListener("mouseup",P),document.removeEventListener("mouseleave",P)}),[$,P]),d.jsxs(R_,{children:[d.jsx(I_,{ref:n,...t,children:e}),d.jsx(N_,{children:d.jsxs(D_,{children:[d.jsx(A_,{ref:r,onClick:c,style:{cursor:m&&"grabbing"}}),d.jsx(H_,{ref:i,onMouseDown:C,onTouchStart:g,style:{height:`${l}px`,cursor:m?"grabbing":"grab"}})]})})]})},{darkColor:$u}=pe,mo={title:"Video",text:"Product Description THOTH",movies:[{id:"1",title:"Video title 1",content:"Slide 1"},{id:"2",title:"Video title 2",content:"Slide 2"},{id:"3",title:"Video title 3",content:"Slide 3"},{id:"4",title:"Video title 4",content:"Slide 4"},{id:"5",title:"Video title 5",content:"Slide 5"}]},B_=y.section`
...
`,P$=d.jsxs(E$,{children:[d.jsx(O$,{children:$n.lineOne.text.button}),d.jsx(b$,{})]}),vp=()=>d.jsx(k$,{children:d.jsx(C$,{type:"button",children:P$,onClick:e1})}),T$=()=>{const e=Bt();return d.jsxs(x$,{children:[d.jsx(_$,{color:gg,children:$n.title}),d.jsxs(dp,{children:[d.jsx(pp,{children:$n.lineOne.title}),d.jsxs(fp,{children:[d.jsx(hp,{children:$n.lineOne.text.main}),d.jsx($$,{children:$n.lineOne.text.span})]}),!e&&d.jsx(vp,{})]}),d.jsxs(dp,{children:[d.jsx(pp,{children:$n.lineTwo.title}),d.jsx(fp,{children:d.jsx(hp,{children:$n.lineTwo.text.main})}),e&&d.jsx(vp,{})]})]})},{whiteColor:j$}=pe,z$=y.h3`
  ${Q};
  text-align: center;
  font-size: calc(25vw / 14.4);
  ${Y};
...
`,wg=({button:e,image:t,title:n,text:r})=>d.jsxs(M$,{children:[e&&d.jsx(I$,{children:e}),d.jsxs(R$,{children:[d.jsxs(H$,{children:[d.jsx(N$,{src:t,alt:n}),d.jsx(D$,{children:n})]}),d.jsx(A$,{children:r})]})]}),F$="/thoth/assets/slider-bitton-a733b85e.svg",B$=y(Ve)`
  padding: 0;
  border: none;
  position: absolute;
  top: 12.5%;
