...
`,rl=x.button`
  ...
  border-radius: 5px;
  cursor: pointer;
`,ZO=()=>{const e=()=>{const i=`https://telegram.me/share/url?url=&text=${encodeURIComponent(selectedNews.title+`
`+selectedNews.text)}`;window.open(i,"_blank")},t=()=>{const i=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}`;window.open(i,"_blank")},n=()=>{const r=encodeURIComponent(selectedNews.title),i=encodeURIComponent(selectedNews.title+`
`+selectedNews.text),o=`mailto:?subject=${r}&body=${i}`;window.location.href=o};return p.jsxs(JO,{children:[p.jsx(TelegramButton,{}),p.jsx(rl,{onClick:e,children:"Share on Telegram"}),p.jsx(rl,{onClick:t,children:"Share on Facebook"}),";",p.jsx(rl,{onClick:n,children:"Send via Email"})]})},{greenColor:eP,smallNewsColor:rd,largeNewsColor:tP,blackColor:nP,lineNewsColor:rP}=re,iP=x.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: row;
...
//# sourceMappingURL=main-0555c797.js.map
