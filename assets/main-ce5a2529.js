 ...
 */var Di=Symbol.for("react.element"),ty=Symbol.for("react.portal"),ny=Symbol.for("react.fragment"),ry=Symbol.for("react.strict_mode"),iy=Symbol.for("react.profiler"),oy=Symbol.for("react.provider"),ay=Symbol.for("react.context"),sy=Symbol.for("react.forward_ref"),ly=Symbol.for("react.suspense"),uy=Symbol.for("react.memo"),cy=Symbol.for("react.lazy"),id=Symbol.iterator;function dy(e){return e===null||typeof e!="object"?null:(e=id&&e[id]||e["@@iterator"],typeof e=="function"?e:null)}var th={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},nh=Object.assign,rh={};function Rr(e,t,n){this.props=e,this.context=t,this.refs=rh,this.updater=n||th}Rr.prototype.isReactComponent={};Rr.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};Rr.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function ih(){}ih.prototype=Rr.prototype;function zu(e,t,n){this.props=e,this.context=t,this.refs=rh,this.updater=n||th}var Iu=zu.prototype=new ih;Iu.constructor=zu;nh(Iu,Rr.prototype);Iu.isPureReactComponent=!0;var od=Array.isArray,oh=Object.prototype.hasOwnProperty,Mu={current:null},ah={key:!0,ref:!0,__self:!0,__source:!0};function sh(e,t,n){var r,i={},o=null,a=null;if(t!=null)for(r in t.ref!==void 0&&(a=t.ref),t.key!==void 0&&(o=""+t.key),t)oh.call(t,r)&&!ah.hasOwnProperty(r)&&(i[r]=t[r]);var s=arguments.length-2;if(s===1)i.children=n;else if(1<s){for(var l=Array(s),u=0;u<s;u++)l[u]=arguments[u+2];i.children=l}if(e&&e.defaultProps)for(r in s=e.defaultProps,s)i[r]===void 0&&(i[r]=s[r]);return{$$typeof:Di,type:e,key:o,ref:a,props:i,_owner:Mu.current}}function fy(e,t){return{$$typeof:Di,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Du(e){return typeof e=="object"&&e!==null&&e.$$typeof===Di}function py(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var ad=/\/+/g;function us(e,t){return typeof e=="object"&&e!==null&&e.key!=null?py(""+e.key):t.toString(36)}function wo(e,t,n,r,i){var o=typeof e;(o==="undefined"||o==="boolean")&&(e=null);var a=!1;if(e===null)a=!0;else switch(o){case"string":case"number":a=!0;break;case"object":switch(e.$$typeof){case Di:case ty:a=!0}}if(a)return a=e,i=i(a),e=r===""?"."+us(a,0):r,od(i)?(n="",e!=null&&(n=e.replace(ad,"$&/")+"/"),wo(i,t,n,"",function(u){return u})):i!=null&&(Du(i)&&(i=fy(i,n+(!i.key||a&&a.key===i.key?"":(""+i.key).replace(ad,"$&/")+"/")+e)),t.push(i)),1;if(a=0,r=r===""?".":r+":",od(e))for(var s=0;s<e.length;s++){o=e[s];var l=r+us(o,s);a+=wo(o,t,n,l,i)}else if(l=dy(e),typeof l=="function")for(e=l.call(e),s=0;!(o=e.next()).done;)o=o.value,l=r+us(o,s++),a+=wo(o,t,n,l,i);else if(o==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return a}function Gi(e,t,n){if(e==null)return e;var r=[],i=0;return wo(e,r,"","",function(o){return t.call(n,o,i++)}),r}function hy(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(n){(e._status===0||e._status===-1)&&(e._status=1,e._result=n)},function(n){(e._status===0||e._status===-1)&&(e._status=2,e._result=n)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var Fe={current:null},xo={transition:null},gy={ReactCurrentDispatcher:Fe,ReactCurrentBatchConfig:xo,ReactCurrentOwner:Mu};J.Children={map:Gi,forEach:function(e,t,n){Gi(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return Gi(e,function(){t++}),t},toArray:function(e){return Gi(e,function(t){return t})||[]},only:function(e){if(!Du(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};J.Component=Rr;J.Fragment=ny;J.Profiler=iy;J.PureComponent=zu;J.StrictMode=ry;J.Suspense=ly;J.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=gy;J.cloneElement=function(e,t,n){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r=nh({},e.props),i=e.key,o=e.ref,a=e._owner;if(t!=null){if(t.ref!==void 0&&(o=t.ref,a=Mu.current),t.key!==void 0&&(i=""+t.key),e.type&&e.type.defaultProps)var s=e.type.defaultProps;for(l in t)oh.call(t,l)&&!ah.hasOwnProperty(l)&&(r[l]=t[l]===void 0&&s!==void 0?s[l]:t[l])}var l=arguments.length-2;if(l===1)r.children=n;else if(1<l){s=Array(l);for(var u=0;u<l;u++)s[u]=arguments[u+2];r.children=s}return{$$typeof:Di,type:e.type,key:i,ref:o,props:r,_owner:a}};J.createContext=function(e){return e={$$typeof:ay,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:oy,_context:e},e.Consumer=e};J.createElement=sh;J.createFactory=function(e){var t=sh.bind(null,e);return t.type=e,t};J.createRef=function(){return{current:null}};J.forwardRef=function(e){return{$$typeof:sy,render:e}};J.isValidElement=Du;J.lazy=function(e){return{$$typeof:cy,_payload:{_status:-1,_result:e},_init:hy}};J.memo=function(e,t){return{$$typeof:uy,type:e,compare:t===void 0?null:t}};J.startTransition=function(e){var t=xo.transition;xo.transition={};try{e()}finally{xo.transition=t}};J.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};J.useCallback=function(e,t){return Fe.current.useCallback(e,t)};J.useContext=function(e){return Fe.current.useContext(e)};J.useDebugValue=function(){};J.useDeferredValue=function(e){return Fe.current.useDeferredValue(e)};J.useEffect=function(e,t){return Fe.current.useEffect(e,t)};J.useId=function(){return Fe.current.useId()};J.useImperativeHandle=function(e,t,n){return Fe.current.useImperativeHandle(e,t,n)};J.useInsertionEffect=function(e,t){return Fe.current.useInsertionEffect(e,t)};J.useLayoutEffect=function(e,t){return Fe.current.useLayoutEffect(e,t)};J.useMemo=function(e,t){return Fe.current.useMemo(e,t)};J.useReducer=function(e,t,n){return Fe.current.useReducer(e,t,n)};J.useRef=function(e){return Fe.current.useRef(e)};J.useState=function(e){return Fe.current.useState(e)};J.useSyncExternalStore=function(e,t,n){return Fe.current.useSyncExternalStore(e,t,n)};J.useTransition=function(){return Fe.current.useTransition()};J.version="18.2.0";eh.exports=J;var j=eh.exports;const gt=Nu(j),my=Zp({__proto__:null,default:gt},[j]);var lh={exports:{}},ja={};/**
 * @license React
...
`,Hs=({index:e,content:t})=>p.jsxs(TS,{children:[p.jsx(NS,{$index:e,src:t.image.src,alt:t.image.alt}),p.jsx(_S,{children:t.subtitle}),p.jsx(RS,{children:t.text})]}),{whiteColor:Uc}=re,zS=x.div`
  padding: 1vw 0.5vw;
  display: flex;
  flex-direction: column;
  border-bottom: none;
...
`,Bc=({children:e,...t})=>p.jsx(qS,{...t,children:e}),{darkGrayColor:Bf}=re,VS=x.div`
  position: relative;
  margin: 0 auto 2vw;
  ${Ac};
  width: 93.54vw;
...
`,Xc=({children:e,...t})=>p.jsx(g2,{...t,children:e}),{greenColor:Nv}=re,m2=x.div`
  width: 100%;
...
`,z2=x.div`
  ...
  flex-direction: row;
  justify-content: center;
`,I2=({id:e,title:t})=>{const n=jt(),{t:r}=ut(),i=xt("ProductAndService",r),{text:o,slides:a,mobileWallet:s,availableCurrencies:l,videoSlider:u}=i,[d,c]=j.useState(a[0].id),f=w=>{c(w)},y=a.map(w=>w.id),v=a.find(w=>w.id===d);return p.jsxs("section",{id:e,children:[p.jsxs(_2,{children:[p.jsx(R2,{color:fp,children:t}),p.jsx(N2,{color:fp,children:o}),!n&&p.jsx(z2,{children:y.map((w,C)=>{const g=d===w,h=a.find(m=>m.id===w);if(h){const S=[29,29,27,15][C];return p.jsx(T2,{id:h.id,width:`${S}%`,isActive:g,onClick:f,children:p.jsx(Xc,{children:h.subtitle})},h.id)}return null})}),n?p.jsx(O2,{slides:a,links:s.links}):v&&p.jsx(zv,{slide:v,links:s.links})]}),p.jsx(lb,{mobileWallet:s}),p.jsx(h2,{availableCurrencies:l})]})},{whiteColor:M2,greenColor:D2,lightGreenColor:A2}=re,F2=x.div`
  grid-column: 3 / 4;
  width: 100%;
  display: flex;
  justify-content: end;
...
`,C$=({news:e})=>{const{title:t,link:n}=e,r=Cu,i=jt(),o=r.slice(0,2),a=r.slice(2,5);return p.jsxs(w$,{children:[p.jsxs(S$,{children:[p.jsx(Lt,{color:v$,children:t}),p.jsx(b$,{color:"transparent",href:n.href,target:"_blank",rel:"noopener noreferrer",children:n.value})]}),p.jsxs(x$,{children:[p.jsx(k$,{children:o.map(s=>p.jsx($u,{slide:s,size:"big"},s.id))}),i?p.jsx(m$,{slides:a,size:"small"}):p.jsx($$,{children:a.map(s=>p.jsx($u,{slide:s,size:"small"},s.id))})]})]})},{deepColor:fi,darkGreenColor:Ou}=re,O$=x.section`
  display: flex;
  flex-direction: row;
  align-items: start;
  justify-content: space-between;
...
`,Fv=({navigation:e})=>{const{button:t,separator:n,location:r}=e,[i,o]=j.useState(!1),a=Dr(),s=()=>{o(!0),a("/")};return p.jsxs(M$,{children:[p.jsx(D$,{type:"button",disabled:i,onClick:s,children:p.jsx(el,{children:t})}),p.jsx(el,{children:n}),p.jsx(el,{children:r})]})},{ratesFeesColor:A$,darkGreenColor:Pu,blackColor:F$,whiteColor:H$}=re,U$=x.div`
...
`,rO=x(Ke)`
  ...
  background: transparent;
  border-radius: 50px;
`,_u=({image:e,isButton:t=!1,onClick:n})=>{const{src:r,alt:i,text:o}=e;return p.jsxs(tO,{children:[t&&n?p.jsx(rO,{type:"button",disabled:!1,onClick:n,children:p.jsx(Ap,{src:r,alt:i,$isButton:t})}):p.jsx(Ap,{src:r,alt:i,$isButton:t}),p.jsx(nO,{children:o})]})},iO=x.div`
  display: flex;
  gap: 1vw;
  flex-direction: row;
  justify-content: left;
...
`,lO=x(Ke)`
  ...
  ${({$code:e,$currentLanguage:t})=>e===t&&ve`
    ...
    `}
`,uO=({language:e,isLanguagesOpen:t,languagesHandler:n,closeIcon:r})=>{const{i18n:i}=ut(),[o,a]=j.useState(i.language),s=async u=>{a(u),await i.changeLanguage(u),n()},l=u=>async()=>{await s(u)};return p.jsxs(sO,{children:[p.jsxs(iO,{children:[p.jsx(oO,{disabled:!t,type:"button",onClick:n,children:p.jsx(aO,{src:r.src,alt:r.alt})}),p.jsx(_u,{image:e})]}),gS.map(u=>p.jsx(lO,{type:"button",disabled:!t,$code:u.code,$currentLanguage:o,onClick:l(u.code),children:u.name},u.code))]})},{whiteColor:Xv,greenColor:cO,lightGreenColor:dO}=re,fO=x.div`
  position: relative;
  z-index: 11;
  width: 15.5vw;
  display: flex;
...
`,bO=x.div`
  ...
  justify-content: start;
  align-items: center;
`,kO=({language:e,menu:t,sections:n,headerHeight:r,languagesHandler:i,isBurgerMenuOpen:o,burgerMenuHandler:a,loginAndRegister:s,closeIcon:l})=>p.jsxs(yO,{children:[p.jsxs(wO,{children:[p.jsx(xO,{disabled:!o,type:"button",onClick:a,children:p.jsx(SO,{src:l.src,alt:l.alt})}),p.jsx(_u,{image:t})]}),p.jsx(Zv,{sections:n,headerHeight:r,burgerMenuHandler:a}),p.jsx(bO,{children:p.jsx(_u,{image:e,isButton:!0,onClick:i})}),p.jsx(Jv,{loginAndRegister:s,onClick:a}),p.jsx(ed,{$location:"menu",type:"light",onClick:a})]}),$O=x.div`
  display: flex;
  flex-direction: column;
  align-items: start;
  box-sizing: border-box;
...
`,nd=x.button`
  ...
  border-radius: 5px;
  cursor: pointer;
`,ZO=({selectedNews:e})=>{const t=()=>{const r=`https://telegram.me/share/url?url=&text=${encodeURIComponent(e.title+`
`+e.text)}`;window.open(r,"_blank")};return p.jsx(nd,{onClick:t,children:"Share on Telegram"})},eP=()=>{const e=()=>{const n=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}`;window.open(n,"_blank")};return p.jsx(nd,{onClick:e,children:"Share on Facebook"})},tP=()=>{const e=()=>{const t=encodeURIComponent(selectedNews.title),n=encodeURIComponent(selectedNews.title+`
`+selectedNews.text),r=`mailto:?subject=${t}&body=${n}`;window.location.href=r};return p.jsx(nd,{onClick:e,children:"Send via Email"})},nP=()=>p.jsxs(JO,{children:[p.jsx(ZO,{}),p.jsx(eP,{}),p.jsx(tP,{})]}),{greenColor:rP,smallNewsColor:rd,largeNewsColor:iP,blackColor:oP,lineNewsColor:aP}=re,sP=x.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: row;
...
`,vP=()=>{const{t:e}=ut(),t=xt("News",e),{rating:n}=t,{id:r}=yx(),i=Dr();j.useEffect(()=>{console.log(`добавить просмотр новости с ${r}`)},[r]);const o=Cu.find(c=>c.id===r);if(!o)return p.jsx(Hv,{});const a=Cu.filter(c=>c.id!==r),s=c=>{i(`/news/${c}`)},l=o.text.split(" ").length,d=Math.ceil(l/250);return p.jsxs(sP,{children:[p.jsxs(lP,{children:[p.jsx(Gp,{size:"big",src:o.url,alt:o.title}),p.jsxs(hP,{children:[p.jsx(Kp,{children:o.date}),p.jsxs(gP,{children:[p.jsx(Qp,{size:"big",children:o.title}),p.jsxs(mP,{children:[p.jsx(XO,{id:o.id,initialValue:o.rating,ratingData:n}),p.jsxs(Yp,{children:[p.jsx(Jp,{src:t.views.src,alt:t.views.alt}),p.jsx(Xp,{children:o.views})]}),p.jsxs(Yp,{children:[p.jsx(Jp,{src:t.time.src,alt:t.time.alt}),p.jsxs(Xp,{children:[d," ",t.time.text]})]})]}),p.jsx(pP,{children:o.text})]})]})]}),p.jsxs(uP,{children:[p.jsx(nP,{selectedNews:o}),a.map(c=>p.jsxs(cP,{onClick:()=>s(c.id),children:[p.jsx(Gp,{size:"small",src:c.url,alt:c.title}),p.jsxs(dP,{size:"small",children:[p.jsx(fP,{children:c.span}),p.jsx(Kp,{children:c.date})]}),p.jsx(Qp,{size:"small",children:c.title})]},c.id))]})]})},yP=x.div`
