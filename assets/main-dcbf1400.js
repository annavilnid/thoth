 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(T,N){var H=T.length;T.push(N);e:for(;0<H;){var X=H-1>>>1,G=T[X];if(0<i(G,N))T[X]=N,T[H]=G,H=X;else break e}}function n(T){return T.length===0?null:T[0]}function r(T){if(T.length===0)return null;var N=T[0],H=T.pop();if(H!==N){T[0]=H;e:for(var X=0,G=T.length,Pt=G>>>1;X<Pt;){var Oe=2*(X+1)-1,Gt=T[Oe],Qe=Oe+1,jt=T[Qe];if(0>i(Gt,H))Qe<G&&0>i(jt,Gt)?(T[X]=jt,T[Qe]=H,X=Qe):(T[X]=Gt,T[Oe]=H,X=Oe);else if(Qe<G&&0>i(jt,H))T[X]=jt,T[Qe]=H,X=Qe;else break e}}return N}function i(T,N){var H=T.sortIndex-N.sortIndex;return H!==0?H:T.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],u=[],c=1,d=null,f=3,y=!1,v=!1,w=!1,k=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(T){for(var N=n(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=T)r(u),N.sortIndex=N.expirationTime,t(l,N);else break;N=n(u)}}function x(T){if(w=!1,m(T),!v)if(n(l)!==null)v=!0,U(b);else{var N=n(u);N!==null&&V(x,N.startTime-T)}}function b(T,N){v=!1,w&&(w=!1,g(P),P=-1),y=!0;var H=f;try{for(m(N),d=n(l);d!==null&&(!(d.expirationTime>N)||T&&!F());){var X=d.callback;if(typeof X=="function"){d.callback=null,f=d.priorityLevel;var G=X(d.expirationTime<=N);N=e.unstable_now(),typeof G=="function"?d.callback=G:d===n(l)&&r(l),m(N)}else r(l);d=n(l)}if(d!==null)var Pt=!0;else{var Oe=n(u);Oe!==null&&V(x,Oe.startTime-N),Pt=!1}return Pt}finally{d=null,f=H,y=!1}}var $=!1,E=null,P=-1,R=5,z=-1;function F(){return!(e.unstable_now()-z<R)}function B(){if(E!==null){var T=e.unstable_now();z=T;var N=!0;try{N=E(!0,T)}finally{N?A():($=!1,E=null)}}else $=!1}var A;if(typeof p=="function")A=function(){p(B)};else if(typeof MessageChannel<"u"){var C=new MessageChannel,L=C.port2;C.port1.onmessage=B,A=function(){L.postMessage(null)}}else A=function(){k(B,0)};function U(T){E=T,$||($=!0,A())}function V(T,N){P=k(function(){T(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,U(b))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(T){switch(f){case 1:case 2:case 3:var N=3;break;default:N=f}var H=f;f=N;try{return T()}finally{f=H}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,N){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var H=f;f=T;try{return N()}finally{f=H}},e.unstable_scheduleCallback=function(T,N,H){var X=e.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?X+H:X):H=X,T){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=H+G,T={id:c++,callback:N,priorityLevel:T,startTime:H,expirationTime:G,sortIndex:-1},H>X?(T.sortIndex=H,t(u,T),n(l)===null&&T===n(u)&&(w?(g(P),P=-1):w=!0,V(x,H-X))):(T.sortIndex=G,t(l,T),v||y||(v=!0,U(b))),T},e.unstable_shouldYield=F,e.unstable_wrapCallback=function(T){var N=f;return function(){var H=f;f=N;try{return T.apply(this,arguments)}finally{f=H}}}})(dh);ch.exports=dh;var py=ch.exports;/**
 * @license React
...
`,qn=({children:e,...t})=>h.jsx(cS,{...t,children:e}),{lightGrayColor:Xm}=ne,dS=S.div`
  position: relative;
  z-index: 1;
  max-width: 20.16vw;
  display: flex;
...
`,Gs=({index:e,content:t})=>h.jsxs(dS,{children:[h.jsx(hS,{$index:e,src:t.image.src,alt:t.image.alt}),h.jsx(fS,{children:t.subtitle}),h.jsx(pS,{children:t.text})]}),{whiteColor:Xc}=ne,gS=S.div`
  padding: 1vw 0.5vw;
  display: flex;
  flex-direction: column;
  border-bottom: none;
...
`,Yc=({children:e,...t})=>h.jsx(CS,{...t,children:e}),{darkGrayColor:Wf}=ne,OS=S.div`
  position: relative;
  margin: 0 auto 2vw;
  ${Gc};
  width: 93.54vw;
...
`,Vb=()=>{const e=yt();return h.jsxs(Hb,{children:[h.jsx(Et,{color:Cv,children:il.title}),h.jsx(Ub,{children:il.text}),h.jsx(Bb,{children:il.imagesContext.map((t,n)=>h.jsxs(j.Fragment,{children:[h.jsx(Wb,{children:t.text}),e?h.jsx(gp,{slides:t.coins,size:"small"}):h.jsx(gp,{slides:t.coins,size:"big"})]},n))})]})},Kb=S(qn)`
  color: ${ne.whiteColor};
  padding-bottom: 2.57vw;
  background: transparent;
  border-radius: 0;
...
`,vp=({text:e})=>{const[t,n]=j.useState(!1),r=Za(),i=()=>{n(!0),r("/payment-fees"),window.scrollTo({top:0})};return h.jsx(g2,{children:h.jsxs(m2,{type:"button",disabled:t,onClick:i,children:[h.jsx(y2,{children:e}),h.jsx(v2,{})]})})},{lightBlackColor:Pv,blackColor:jv,darkGreenColor:w2}=ne,Xt={title:"Fees",lineOne:{title:"Incoming Transactions",text:{main:"As low as 0.5%",span:"and going down based on your total transaction volume.",button:"Check pricing details"}},lineTwo:{title:"Outgoing Transactions",text:{main:"Free of charge"}}},x2=S.section`
  box-sizing: border-box;
  width: 100vw;
...
`,Lv=({slide:e})=>{const t=yt();return h.jsxs($2,{children:[t&&h.jsx(O2,{children:e.subtitle}),h.jsxs(C2,{children:[h.jsxs(L2,{children:[h.jsx(E2,{src:e.image.src,alt:e.image.alt}),h.jsx(P2,{children:e.title})]}),h.jsx(j2,{children:e.text})]})]})};let wo;const T2=new Uint8Array(16);function _2(){if(!wo&&(wo=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!wo))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return wo(T2)}const Ee=[];for(let e=0;e<256;++e)Ee.push((e+256).toString(16).slice(1));function R2(e,t=0){return(Ee[e[t+0]]+Ee[e[t+1]]+Ee[e[t+2]]+Ee[e[t+3]]+"-"+Ee[e[t+4]]+Ee[e[t+5]]+"-"+Ee[e[t+6]]+Ee[e[t+7]]+"-"+Ee[e[t+8]]+Ee[e[t+9]]+"-"+Ee[e[t+10]]+Ee[e[t+11]]+Ee[e[t+12]]+Ee[e[t+13]]+Ee[e[t+14]]+Ee[e[t+15]]).toLowerCase()}const z2=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),kp={randomUUID:z2};function N2(e,t,n){if(kp.randomUUID&&!t&&!e)return kp.randomUUID();e=e||{};const r=e.random||(e.rng||_2)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){n=n||0;for(let i=0;i<16;++i)t[n+i]=r[i];return t}return R2(r)}const I2=S(qe)`
  padding: 0;
  border: none;
  border-radius: 50%;
  background: transparent;
...
`,Ru=({slide:e,size:t})=>h.jsxs(B2,{size:t,children:[h.jsx(q2,{size:t,src:e.image.src,alt:e.image.alt}),h.jsxs(U2,{size:t,children:[h.jsx(W2,{children:e.span}),h.jsx(V2,{children:e.date})]}),h.jsx(K2,{size:t,children:e.title}),t==="big"&&h.jsx(G2,{size:t,children:e.text})]}),Q2=S.div`
  ...
  margin: 0 auto;
  position: relative;
`,X2=({slides:e,size:t})=>{const n={dots:!1,arrows:!1,infinite:!0,slidesToShow:1,slidesToScroll:1,swipeToSlide:!0,variableWidth:!0,centerMode:!1};return h.jsx(Q2,{children:h.jsx(ds,{...n,children:e.map(r=>h.jsx(Ru,{slide:r,size:t},r.id))})})},{whiteColor:Y2,greenColor:J2}=ne,ol={title:"News",button:"Read more",slides:[{id:"1",span:"Corporate News",date:"20.04.2022",title:"Athletic Club and B2BinPay Join Forces in Historic Partnership",text:"Athletic Club and B2BinPay Join Forces in Historic Partnership",image:Pn.one},{id:"2",span:"Corporate News",date:"21.04.2022",title:"Athletic Club and B2BinPay Join Forces in Historic Partnership",text:"Athletic Club and B2BinPay Join Forces in Historic Partnership",image:Pn.two},{id:"3",span:"Corporate News",date:"22.04.2022",title:"Athletic Club and B2BinPay Join Forces in Historic Partnership",text:"Athletic Club and B2BinPay Join Forces in Historic Partnership",image:Pn.three},{id:"4",span:"Corporate News",date:"23.04.2022",title:"Athletic Club and B2BinPay Join Forces in Historic Partnership",text:"Athletic Club and B2BinPay Join Forces in Historic Partnership",image:Pn.four},{id:"5",span:"Corporate News",date:"24.04.2022",title:"Athletic Club and B2BinPay Join Forces in Historic Partnership",text:"Athletic Club and B2BinPay Join Forces in Historic Partnership",image:Pn.five}]},Z2=S.div`
  box-sizing: border-box;
  width: 100vw;
  padding-bottom: 5vw;
...
`,h$=({id:e,title:t})=>{const n=yt(),[r,i]=j.useState(Cn.slides[0].id),o=l=>{i(l)},a=Cn.slides.map(l=>l.id),s=Cn.slides.find(l=>l.id===r);return h.jsxs("section",{id:e,children:[h.jsxs(u$,{children:[h.jsxs(c$,{children:[h.jsx(Et,{color:Ep,children:t}),h.jsx(d$,{color:Ep,children:Cn.text}),!n&&h.jsx(f$,{style:{display:"none"},children:a.map(l=>{const u=r===l,c=Cn.slides.find(d=>d.id===l);return c?h.jsx(Ev,{id:c.id,length:Cn.slides.length,isActive:u,onClick:o,children:h.jsx(fs,{children:c.subtitle})},c.id):null})})]}),h.jsx(p$,{children:n?h.jsx(F2,{slides:Cn.slides}):s&&s.content.map(l=>h.jsx(Lv,{slide:l},l.id))})]}),h.jsx(b2,{}),h.jsx(o$,{}),h.jsx(l$,{})]})},g$=({mainScreenRef:e,sections:t})=>h.jsxs(h.Fragment,{children:[h.jsx(uS,{ref:e}),t.map(n=>n.id==="1"?h.jsx(TS,{id:n.id,title:n.title},n.id):n.id==="3"?h.jsx(d2,{id:n.id,title:n.title},n.id):n.id==="4"?h.jsx(h$,{id:n.id,title:n.title},n.id):null)]}),{ratesFeesColor:m$,navigateLinkColor:v$}=ne,y$=S.div`
  padding-left: 5.4vw;
  background-color: ${m$};
  display: flex;
  flex-direction: row;
...
`,x$=({navigation:e})=>{const{button:t,separator:n,location:r}=e,[i,o]=j.useState(!1),a=Za(),s=()=>{o(!0),a("/thoth/")};return h.jsxs(y$,{children:[h.jsx(w$,{type:"button",disabled:i,onClick:s,children:h.jsx(ll,{children:t})}),h.jsx(ll,{children:n}),h.jsx(ll,{children:r})]})},{ratesFeesColor:S$,darkGreenColor:Nu,blackColor:k$,whiteColor:b$}=ne,$$=S.div`
...
`,Pp=({rates:e})=>h.jsxs($$,{children:[h.jsx(T$,{children:e.subtitle}),h.jsxs(C$,{children:[Object.keys(e).map(t=>{const n=e[t];return typeof n=="string"?null:h.jsxs(L$,{children:[h.jsx(E$,{children:n.text}),h.jsx("div",{children:n.percent&&n.percent.map((r,i)=>h.jsxs(O$,{children:[h.jsx(P$,{children:r}),n.span&&n.span[i]&&h.jsx(j$,{children:n.span[i]})]},i))})]},t)}),h.jsx(_$,{color:"transparent",href:e.linkHref,target:"_blank",rel:"noopener noreferrer",children:e.linkLabel})]})]}),{lightBlackColor:R$}=ne,z$=S.main`
  width: 100vw;
`,N$=S.div`
  display: flex;
  flex-direction: column;
...
`,D$=j.forwardRef((e,t)=>{const{t:n}=Kt(),r=Gn("PaymentFees",n),{title:i,individual:o,enterprise:a,navigation:s}=r;return h.jsxs(z$,{ref:t,children:[h.jsx(x$,{navigation:s}),h.jsxs(N$,{children:[h.jsx(M$,{color:R$,children:i}),h.jsxs(I$,{children:[h.jsx(Pp,{rates:o}),h.jsx(Pp,{rates:a})]})]})]})}),A$=lx`
  .slick-track {
...
`,{darkGreenColor:F$,lightBlackColor:H$,notFoundColor:B$,headerColor:U$,whiteColor:W$}=ne,V$=S.main`
...
`,Y$=j.forwardRef((e,t)=>{const n=Za(),[r,i]=j.useState(!1),{t:o}=Kt(),a=Gn("NotFound",o),{title:s,subtitle:l,image:u,text:c,button:d}=a,f=()=>{i(!0),n("/")};return h.jsxs(V$,{ref:t,children:[h.jsx(K$,{children:s}),h.jsx(G$,{color:H$,children:l}),h.jsx(q$,{src:u.src,alt:u.alt}),h.jsx(Q$,{children:c}),h.jsx(X$,{type:"button",disabled:r,onClick:f,children:d})]})}),J$=S.img`
  ${ha};
  width: fit-content;
  height: 2.63vw;
...
`,_v=()=>{const{t:e}=Kt(),t=Gn("Logo",e),{src:n,alt:r}=t;return h.jsx(J$,{src:n,alt:r})},Z$=S.div`
  display: flex;
  flex-direction: row;
...
`,tC=S(qe)`
  display: flex;
  background-color: transparent;
`,ad=({type:e,$location:t,onClick:n,...r})=>{const{t:i}=Kt(),o=Gn("FeedbackWidgets",i);return h.jsx(Z$,{$location:t,...r,children:o.map(a=>h.jsx(eC,{color:"transparent",href:a.href,target:"_blank",rel:"noopener noreferrer",children:n?h.jsx(tC,{type:"button",disabled:!n,onClick:n,children:h.jsx(jp,{src:a.image[e==="light"?"lightSrc":"darkSrc"],alt:a.image.alt})}):h.jsx(jp,{src:a.image[e==="light"?"lightSrc":"darkSrc"],alt:a.image.alt})},a.id))})},nC=S.div`
  display: flex;
  gap: 1vw;
  flex-direction: row;
  justify-content: left;
...
`,iC=S(qe)`
  ...
  background: transparent;
  border-radius: 50px;
`,Iu=({image:e,isButton:t=!1,onClick:n})=>{const{src:r,alt:i,text:o}=e;return h.jsxs(nC,{children:[t&&n?h.jsx(iC,{type:"button",disabled:!1,onClick:n,children:h.jsx(Lp,{src:r,alt:i,$isButton:t})}):h.jsx(Lp,{src:r,alt:i,$isButton:t}),h.jsx(rC,{children:o})]})},oC=[{code:"en",name:"English"},{code:"ru",name:"Русский"}],aC=S.div`
  display: flex;
  gap: 1vw;
  flex-direction: row;
  justify-content: left;
...
`,cC=S(qe)`
  ...
  ${({$code:e,$currentLanguage:t})=>e===t&&me`
    ...
    `}
`,dC=({language:e,isLanguagesOpen:t,languagesHandler:n,closeIcon:r})=>{const{i18n:i}=Kt(),[o,a]=j.useState(i.language),s=async u=>{a(u),await i.changeLanguage(u),n()},l=u=>async()=>{await s(u)};return h.jsxs(uC,{children:[h.jsxs(aC,{children:[h.jsx(sC,{disabled:!t,type:"button",onClick:n,children:h.jsx(lC,{src:r.src,alt:r.alt})}),h.jsx(Iu,{image:e})]}),oC.map(u=>h.jsx(cC,{type:"button",disabled:!t,$code:u.code,$currentLanguage:o,onClick:l(u.code),children:u.name},u.code))]})},{whiteColor:Rv,greenColor:fC,lightGreenColor:pC}=ne,hC=S.div`
  position: relative;
  z-index: 11;
  width: 15.5vw;
  display: flex;
...
`,Rp=S(qe)`
  background-color: transparent;
  display: flex;
`,zv=({onClick:e,loginAndRegister:t})=>{const{signUp:n,signIn:r}=t;return h.jsxs(hC,{children:[h.jsx(mC,{color:"transparent",href:Px,target:"_blank",rel:"noopener noreferrer",children:e?h.jsx(Rp,{type:"button",disabled:!e,onClick:e,children:h.jsx(Tp,{children:n})}):h.jsx(Tp,{children:n})}),h.jsx(gC,{color:"transparent",href:Ex,target:"_blank",rel:"noopener noreferrer",children:e?h.jsx(Rp,{type:"button",disabled:!e,onClick:e,children:h.jsx(_p,{children:r})}):h.jsx(_p,{children:r})})]})},vC=S.ul`
  position: relative;
  z-index: 11;
  ${J};
  display: flex;
...
`,$C=S.div`
  ...
  justify-content: start;
  align-items: center;
`,CC=({language:e,menu:t,sections:n,headerHeight:r,languagesHandler:i,isBurgerMenuOpen:o,burgerMenuHandler:a,loginAndRegister:s,closeIcon:l})=>h.jsxs(xC,{children:[h.jsxs(SC,{children:[h.jsx(kC,{disabled:!o,type:"button",onClick:a,children:h.jsx(bC,{src:l.src,alt:l.alt})}),h.jsx(Iu,{image:t})]}),h.jsx(Nv,{sections:n,headerHeight:r,burgerMenuHandler:a}),h.jsx($C,{children:h.jsx(Iu,{image:e,isButton:!0,onClick:i})}),h.jsx(zv,{loginAndRegister:s,onClick:a}),h.jsx(ad,{$location:"menu",type:"light",onClick:a})]}),OC=S.div`
  display: flex;
  flex-direction: column;
  align-items: start;
  box-sizing: border-box;
...
`,zp=({containerHeight:e,headerHeight:t,children:n,isOpen:r})=>{const i=Ja(),o=yt(),a=i.pathname==="/";return j.useLayoutEffect(()=>{const s=()=>{document.querySelectorAll(".drop-right").forEach(u=>{u.style.height=`calc(${e}px + ${t}px + ${!o&&a?1.7:0}vw)`})};return s(),window.addEventListener("resize",s),()=>{window.removeEventListener("resize",s)}},[e,t,o]),h.jsx(OC,{className:"drop-right",$isOpen:r,children:n})},{whiteColor:EC,headerColor:PC}=ne,jC=S.header`
  background-color: ${PC};
...
`,NC=S.img`
  width: 2.22vw;
  height: 2.22vw;
`,IC=j.forwardRef(({sections:e,containerHeight:t,isLanguagesOpen:n,isBurgerMenuOpen:r,languagesHandler:i,burgerMenuHandler:o,headerHeight:a},s)=>{const{t:l}=Kt(),u=Gn("Header",l),{loginAndRegister:c,language:d,menu:f,closeIcon:y}=u,v=yt();return h.jsxs(h.Fragment,{children:[h.jsxs(jC,{ref:s,children:[h.jsx(_C,{children:h.jsx(_v,{})}),v!==null&&!v&&h.jsxs(h.Fragment,{children:[h.jsx(RC,{type:"light",$location:"menu"}),h.jsx(Nv,{sections:e,headerHeight:a,isLanguagesOpen:n,languagesHandler:i}),h.jsx(zv,{loginAndRegister:c}),h.jsx(zC,{disabled:!!n,type:"button",onClick:i,children:h.jsx(NC,{src:d.srcGray,alt:d.alt})})]}),v&&h.jsx(LC,{disabled:!!r,type:"button",onClick:o,children:h.jsx(TC,{src:f.src,alt:f.alt})})]}),v&&h.jsx(zp,{isOpen:r,headerHeight:a,containerHeight:t,children:h.jsx(CC,{containerHeight:t,sections:e,headerHeight:a,isBurgerMenuOpen:r,burgerMenuHandler:o,languagesHandler:i,language:d,menu:f,loginAndRegister:c,closeIcon:y})}),h.jsx(zp,{isOpen:n,headerHeight:a,containerHeight:t,children:h.jsx(dC,{containerHeight:t,headerHeight:a,isLanguagesOpen:n,languagesHandler:i,language:d,closeIcon:y})})]})}),{whiteColor:sd}=ne,MC=S.div`
  min-width: 10vw;
  display: flex;
  flex-direction: column;
  text-align: left;
...
`,ul=({data:e})=>h.jsxs(MC,{children:[h.jsx(DC,{children:e.title}),h.jsx(AC,{children:e.links.map(t=>h.jsx(FC,{children:h.jsx(wt,{color:sd,href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.name})},t.name))})]}),{whiteColor:Mu,deepGrayColor:HC}=ne,Lt={text:"Our vision is to provide convenience and help increase your sales business.",nav:{about:{title:"About",links:[{name:"How it works",href:Ax},{name:"Featured",href:Fx},{name:"Partnership",href:Hx},{name:"Business Relation",href:Bx}]},community:{title:"Community",links:[{name:"Events",href:Ux},{name:"Blog",href:Wx},{name:"Podcast",href:Vx},{name:"Invite a friend",href:Kx}]},socials:{title:"Socials",links:[{name:"Telegram",href:qm},{name:"Twitter",href:Km},{name:"Facebook",href:Gm}]}},rights:"Auto Fast. All rights reserved",policy:{name:"Privacy & Policy",href:Gx},condition:{name:"Terms & Condition",href:qx}},BC=S.footer`
  width: 100vw;
  box-sizing: border-box;
...
`,dl=({children:e,sections:t,isLanguagesOpen:n,isBurgerMenuOpen:r,languagesHandler:i,burgerMenuHandler:o,paymentFeesHeight:a,mainScreenHeight:s,notFoundHeight:l})=>{const u=j.useRef(null),[c,d]=j.useState(0),f=yt();return j.useEffect(()=>{document.documentElement.lang=Ce.language},[]),j.useEffect(()=>{const y=()=>{if(u.current){const v=u.current.clientHeight;d(v)}};return y(),window.addEventListener("resize",y),()=>{window.removeEventListener("resize",y)}},[u,r,n,f]),h.jsxs(Cx,{i18n:Ce,children:[h.jsx(IC,{ref:u,headerHeight:c,isLanguagesOpen:n,isBurgerMenuOpen:r,languagesHandler:i,burgerMenuHandler:o,containerHeight:s||a||l,paymentFeesHeight:a,sections:t}),h.jsxs(LO,{className:"styled-container",$isBurgerMenuOpen:r,$containerHeight:s||a||l,$isLanguagesOpen:n,$headerHeight:c,children:[e,h.jsx(QC,{})]})]})},TO=()=>{const e=j.useRef(null),t=j.useRef(null),n=j.useRef(null),[r,i]=j.useState(null),[o,a]=j.useState(null),[s,l]=j.useState(0),[u,c]=j.useState(0),[d,f]=j.useState(0),{t:y}=Kt(),v=Gn("Sections",y);j.useEffect(()=>{const p=()=>{if(e.current){const m=e.current.clientHeight;l(m)}};return p(),window.addEventListener("resize",p),()=>{window.removeEventListener("resize",p),l(0)}},[e,o,r]),j.useEffect(()=>{const p=()=>{if(t.current){const m=t.current.clientHeight;c(m)}};return p(),window.addEventListener("resize",p),()=>{window.removeEventListener("resize",p),c(0)}},[t,o,r]),j.useEffect(()=>{const p=()=>{if(n.current){const m=n.current.clientHeight;f(m)}};return p(),window.addEventListener("resize",p),()=>{window.removeEventListener("resize",p),f(0)}},[n,o,r]);const w=()=>{setTimeout(()=>{window.scrollTo({top:0,behavior:"smooth"})},300)},k=()=>{i(!r),o&&g(),r||w()},g=()=>{a(!o),o||w()};return console.log(`mainScreenHeight: ${s}`),console.log(`paymentFeesHeight: ${u}`),console.log(`notFoundHeight: ${d}`),h.jsxs(s1,{basename:"/thoth/",children:[h.jsx(A$,{}),h.jsxs(o1,{children:[h.jsx(zo,{path:"/",element:h.jsx(dl,{isLanguagesOpen:r,isBurgerMenuOpen:o,languagesHandler:k,burgerMenuHandler:g,paymentFeesHeight:u,mainScreenHeight:s,notFoundHeight:d,sections:v,children:h.jsx(g$,{mainScreenRef:e,sections:v})})}),h.jsx(zo,{path:"/payment-fees",element:h.jsx(dl,{isLanguagesOpen:r,isBurgerMenuOpen:o,languagesHandler:k,burgerMenuHandler:g,paymentFeesHeight:u,mainScreenHeight:s,notFoundHeight:d,sections:v,children:h.jsx(D$,{ref:t})})}),h.jsx(zo,{path:"*",element:h.jsx(dl,{isLanguagesOpen:r,isBurgerMenuOpen:o,languagesHandler:k,burgerMenuHandler:g,paymentFeesHeight:u,mainScreenHeight:s,notFoundHeight:d,sections:v,children:h.jsx(Y$,{ref:n})})})]})]})};fl.createRoot(document.getElementById("root")).render(h.jsx(j.StrictMode,{children:h.jsx(TO,{})}));
//# sourceMappingURL=main-dcbf1400.js.map
