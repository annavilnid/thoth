...
`,Wj=x.img`
  width: 2.22vw;
  height: 2.22vw;
`,Vj=E.forwardRef(({sections:e,containerHeight:t,isLanguagesOpen:n,isBurgerMenuOpen:r,languagesHandler:i,burgerMenuHandler:o,headerHeight:a},s)=>{const{t:l}=Rt(),u=Vt("Header",l),{loginAndRegister:f,language:d,menu:c,closeIcon:y}=u,v=rn();return h.jsxs(h.Fragment,{children:[h.jsxs(zj,{ref:s,children:[h.jsx(Uj,{children:h.jsx(n1,{})}),v!==null&&!v&&h.jsxs(h.Fragment,{children:[h.jsx(Hj,{type:"light",$location:"menu"}),h.jsx(r1,{sections:e,headerHeight:a,isLanguagesOpen:n,languagesHandler:i}),h.jsx(o1,{loginAndRegister:f}),h.jsx(Bj,{disabled:!!n,type:"button",onClick:i,children:h.jsx(Wj,{src:d.srcGray,alt:d.alt})})]}),v&&h.jsx(Dj,{disabled:!!r,type:"button",onClick:o,children:h.jsx(Mj,{src:c.src,alt:c.alt})})]}),v&&h.jsx(um,{isOpen:r,headerHeight:a,containerHeight:t,children:h.jsx(Ij,{containerHeight:t,sections:e,headerHeight:a,isBurgerMenuOpen:r,burgerMenuHandler:o,languagesHandler:i,language:d,menu:c,loginAndRegister:f,closeIcon:y})}),h.jsx(um,{isOpen:n,headerHeight:a,containerHeight:t,children:h.jsx(xj,{containerHeight:t,headerHeight:a,isLanguagesOpen:n,languagesHandler:i,language:d,closeIcon:y})})]})}),{whiteColor:ep}=ae,qj=x.div`
  min-width: 10vw;
  display: flex;
  flex-direction: column;
  text-align: left;
...
//# sourceMappingURL=main-e70bd1fb.js.map
