...
`,Lv=({slide:e})=>{const t=yt();return h.jsxs(C2,{children:[t&&h.jsx(O2,{children:e.subtitle}),h.jsxs($2,{children:[h.jsxs(L2,{children:[h.jsx(E2,{src:e.image.src,alt:e.image.alt}),h.jsx(P2,{children:e.title})]}),h.jsx(j2,{children:e.text})]})]})};let wo;const T2=new Uint8Array(16);function _2(){if(!wo&&(wo=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!wo))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return wo(T2)}const Ee=[];for(let e=0;e<256;++e)Ee.push((e+256).toString(16).slice(1));function R2(e,t=0){return(Ee[e[t+0]]+Ee[e[t+1]]+Ee[e[t+2]]+Ee[e[t+3]]+"-"+Ee[e[t+4]]+Ee[e[t+5]]+"-"+Ee[e[t+6]]+Ee[e[t+7]]+"-"+Ee[e[t+8]]+Ee[e[t+9]]+"-"+Ee[e[t+10]]+Ee[e[t+11]]+Ee[e[t+12]]+Ee[e[t+13]]+Ee[e[t+14]]+Ee[e[t+15]]).toLowerCase()}const z2=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),kp={randomUUID:z2};function N2(e,t,n){if(kp.randomUUID&&!t&&!e)return kp.randomUUID();e=e||{};const r=e.random||(e.rng||_2)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){n=n||0;for(let i=0;i<16;++i)t[n+i]=r[i];return t}return R2(r)}const I2=S(qe)`
  padding: 0;
  border: none;
  border-radius: 50%;
  background: transparent;
