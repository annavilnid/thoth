...
`,Av=()=>{const{t:e}=Wt(),t=Gn("Logo",e),{src:n,alt:r}=t;return h.jsx(_C,{src:n,alt:r})},RC=S.div`
  display: flex;
  flex-direction: row;
...
`,NC=S(qe)`
  display: flex;
  background-color: transparent;
`,ad=({type:e,$location:t,onClick:n,...r})=>{const{t:i}=Wt(),o=Gn("FeedbackWidgets",i);return h.jsx(RC,{$location:t,...r,children:o.map(a=>h.jsx(zC,{color:"transparent",href:a.href,target:"_blank",rel:"noopener noreferrer",children:n?h.jsx(NC,{type:"button",disabled:!n,onClick:n,children:h.jsx(Bp,{src:a.image[e==="light"?"lightSrc":"darkSrc"],alt:a.image.alt})}):h.jsx(Bp,{src:a.image[e==="light"?"lightSrc":"darkSrc"],alt:a.image.alt})},a.id))})},IC=S.div`
  display: flex;
  gap: 1vw;
  flex-direction: row;
  justify-content: left;
...
`,DC=S(qe)`
  ...
  background: transparent;
  border-radius: 50px;
`,Fu=({image:e,isButton:t=!1,onClick:n})=>{const{src:r,alt:i,text:o}=e;return h.jsxs(IC,{children:[t&&n?h.jsx(DC,{type:"button",disabled:!1,onClick:n,children:h.jsx(Up,{src:r,alt:i,$isButton:t})}):h.jsx(Up,{src:r,alt:i,$isButton:t}),h.jsx(MC,{children:o})]})},FC=[{code:"en",name:"English"},{code:"ru",name:"Русский"}],AC=S.div`
  display: flex;
  gap: 1vw;
  flex-direction: row;
  justify-content: left;
...
`,WC=S(qe)`
  ...
  ${({$code:e,$currentLanguage:t})=>e===t&&me`
    ...
    `}
`,VC=({language:e,isLanguagesOpen:t,languagesHandler:n,closeIcon:r})=>{const{i18n:i}=Wt(),[o,a]=j.useState(i.language),s=async u=>{a(u),await i.changeLanguage(u),n()},l=u=>async()=>{await s(u)};return h.jsxs(UC,{children:[h.jsxs(AC,{children:[h.jsx(HC,{disabled:!t,type:"button",onClick:n,children:h.jsx(BC,{src:r.src,alt:r.alt})}),h.jsx(Fu,{image:e})]}),FC.map(u=>h.jsx(WC,{type:"button",disabled:!t,$code:u.code,$currentLanguage:o,onClick:l(u.code),children:u.name},u.code))]})},{whiteColor:Hv,greenColor:KC,lightGreenColor:GC}=ne,qC=S.div`
  position: relative;
  z-index: 11;
  width: 15.5vw;
  display: flex;
...
`,Kp=S(qe)`
  background-color: transparent;
  display: flex;
`,Bv=({onClick:e,loginAndRegister:t})=>{const{signUp:n,signIn:r}=t;return h.jsxs(qC,{children:[h.jsx(XC,{color:"transparent",href:Px,target:"_blank",rel:"noopener noreferrer",children:e?h.jsx(Kp,{type:"button",disabled:!e,onClick:e,children:h.jsx(Wp,{children:n})}):h.jsx(Wp,{children:n})}),h.jsx(QC,{color:"transparent",href:Ex,target:"_blank",rel:"noopener noreferrer",children:e?h.jsx(Kp,{type:"button",disabled:!e,onClick:e,children:h.jsx(Vp,{children:r})}):h.jsx(Vp,{children:r})})]})},YC=S.ul`
  position: relative;
  z-index: 11;
  ${J};
  display: flex;
...
`,iO=S.div`
  ...
  justify-content: start;
  align-items: center;
`,oO=({language:e,menu:t,sections:n,headerHeight:r,languagesHandler:i,isBurgerMenuOpen:o,burgerMenuHandler:a,loginAndRegister:s,closeIcon:l})=>h.jsxs(eO,{children:[h.jsxs(tO,{children:[h.jsx(nO,{disabled:!o,type:"button",onClick:a,children:h.jsx(rO,{src:l.src,alt:l.alt})}),h.jsx(Fu,{image:t})]}),h.jsx(Uv,{sections:n,headerHeight:r,burgerMenuHandler:a}),h.jsx(iO,{children:h.jsx(Fu,{image:e,isButton:!0,onClick:i})}),h.jsx(Bv,{loginAndRegister:s,onClick:a}),h.jsx(ad,{$location:"menu",type:"light",onClick:a})]}),aO=S.div`
  display: flex;
  flex-direction: column;
  align-items: start;
  box-sizing: border-box;
...
`,Gp=({containerHeight:e,headerHeight:t,children:n,isOpen:r})=>{const i=ns(),o=Ot(),a=i.pathname==="/";return j.useLayoutEffect(()=>{const s=()=>{document.querySelectorAll(".drop-right").forEach(u=>{u.style.height=`calc(${e}px + ${t}px + ${!o&&a?1.7:0}vw)`})};return s(),window.addEventListener("resize",s),()=>{window.removeEventListener("resize",s)}},[e,t,o]),h.jsx(aO,{className:"drop-right",$isOpen:r,children:n})},{whiteColor:sO,headerColor:lO}=ne,uO=S.header`
  background-color: ${lO};
...
`,gO=S.img`
  width: 2.22vw;
  height: 2.22vw;
`,mO=j.forwardRef(({sections:e,containerHeight:t,isLanguagesOpen:n,isBurgerMenuOpen:r,languagesHandler:i,burgerMenuHandler:o,headerHeight:a},s)=>{const{t:l}=Wt(),u=Gn("Header",l),{loginAndRegister:c,language:d,menu:f,closeIcon:y}=u,v=Ot();return h.jsxs(h.Fragment,{children:[h.jsxs(uO,{ref:s,children:[h.jsx(fO,{children:h.jsx(Av,{})}),v!==null&&!v&&h.jsxs(h.Fragment,{children:[h.jsx(pO,{type:"light",$location:"menu"}),h.jsx(Uv,{sections:e,headerHeight:a,isLanguagesOpen:n,languagesHandler:i}),h.jsx(Bv,{loginAndRegister:c}),h.jsx(hO,{disabled:!!n,type:"button",onClick:i,children:h.jsx(gO,{src:d.srcGray,alt:d.alt})})]}),v&&h.jsx(cO,{disabled:!!r,type:"button",onClick:o,children:h.jsx(dO,{src:f.src,alt:f.alt})})]}),v&&h.jsx(Gp,{isOpen:r,headerHeight:a,containerHeight:t,children:h.jsx(oO,{containerHeight:t,sections:e,headerHeight:a,isBurgerMenuOpen:r,burgerMenuHandler:o,languagesHandler:i,language:d,menu:f,loginAndRegister:c,closeIcon:y})}),h.jsx(Gp,{isOpen:n,headerHeight:a,containerHeight:t,children:h.jsx(VC,{containerHeight:t,headerHeight:a,isLanguagesOpen:n,languagesHandler:i,language:d,closeIcon:y})})]})}),{whiteColor:sd}=ne,vO=S.div`
  min-width: 10vw;
  display: flex;
  flex-direction: column;
  text-align: left;
...
`,cl=({data:e})=>h.jsxs(vO,{children:[h.jsx(yO,{children:e.title}),h.jsx(wO,{children:e.links.map(t=>h.jsx(xO,{children:h.jsx(yt,{color:sd,href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.name})},t.name))})]}),{whiteColor:Au,deepGrayColor:SO}=ne,Lt={text:"Our vision is to provide convenience and help increase your sales business.",nav:{about:{title:"About",links:[{name:"How it works",href:Fx},{name:"Featured",href:Ax},{name:"Partnership",href:Hx},{name:"Business Relation",href:Bx}]},community:{title:"Community",links:[{name:"Events",href:Ux},{name:"Blog",href:Wx},{name:"Podcast",href:Vx},{name:"Invite a friend",href:Kx}]},socials:{title:"Socials",links:[{name:"Telegram",href:Gm},{name:"Twitter",href:Vm},{name:"Facebook",href:Km}]}},rights:"Auto Fast. All rights reserved",policy:{name:"Privacy & Policy",href:Gx},condition:{name:"Terms & Condition",href:qx}},kO=S.footer`
  width: 100vw;
  box-sizing: border-box;
...
`,jO=()=>{const e=new Date().getFullYear();return h.jsxs(kO,{children:[h.jsxs(bO,{children:[h.jsxs(EO,{children:[h.jsx(OO,{}),h.jsx(qp,{children:Lt.text}),h.jsx(PO,{type:"dark"})]}),h.jsx(cl,{data:Lt.nav.about}),h.jsx(cl,{data:Lt.nav.community}),h.jsx(cl,{data:Lt.nav.socials})]}),h.jsxs($O,{children:[h.jsxs(qp,{children:["© ",e," ",Lt.rights]}),h.jsxs(CO,{children:[h.jsx(Xp,{color:Au,href:Lt.policy.href,target:"_blank",rel:"noopener noreferrer",children:h.jsx(Qp,{children:Lt.policy.name})}),h.jsx(Xp,{color:Au,href:Lt.condition.href,target:"_blank",rel:"noopener noreferrer",children:h.jsx(Qp,{children:Lt.condition.name})})]})]})]})},LO=S.div`
